...
<html lang="en">
  <head>
    ...
    <title>Basis Data Muh Bazhar</title>
  </head>
  <style type="text/css">
...
#particles-js{
  ...
  <?php 
      ...
      <div class="modal-header"><button onclick='change();'  value='show' id='btn1' type="button" class="btn btn-secondary">TAMBAH MENU</button></a>
  </div>
<br>
